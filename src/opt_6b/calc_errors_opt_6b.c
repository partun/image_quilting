    ...
    for (int candidate_y = 0; candidate_y < max_src_y; ++candidate_y) {
        for (int candidate_x = 0; candidate_x < max_src_x; ++candidate_x) {
            ...
            if (direction == ABOVE || direction == CORNER) {
                ...
                int block_y = 0;
                while (block_y < overlap && error <= threshold) {
            ...
            if (direction == LEFT) {
                ...
                int block_y = 0;
                while (block_y < block_size && error <= threshold) {
            ...
            if (error < min_err_opt_6b) {
                min_err_opt_6b = error;
                threshold = (int) (min_err_opt_6b * tolerance_6b);
            }
...
*/    int candidate_idx = 0;
    ...
    int threshold = (int) (min_err_opt_6b * tolerance_6b);
