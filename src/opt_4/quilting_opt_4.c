#include "src/opt_4/calc_errors_opt_4.h"
#include "src/opt_4/min_cut_opt_4.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
