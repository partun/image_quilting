...
Matrix *min_cut(
    ...
    if (direction == ABOVE) {
        Matrix *error_matrix = calc_overlap_error(source_image, output_image, block_coords,
                                                  output_coords,
                                                  block_size,
                                                  overlap);
        ...
        Matrix *error_matrix_left = calc_overlap_error(source_image, output_image, block_coords,
                                                       output_coords,
                                                       overlap,
                                                       block_size);
        Matrix *cut_left = calc_cut_mask(error_matrix_left, block_size);

        Matrix *error_matrix_above = calc_overlap_error(source_image, output_image, block_coords,
                                                        output_coords,
                                                        block_size,
                                                        overlap);
